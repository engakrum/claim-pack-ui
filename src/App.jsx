...
/* =========================================
   PART 1: THE DASHBOARD (The App)
   Matches screenshot: Dark Mode, Glassmorphism
   ========================================= */
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 space-y-8">
            <section className="space-y-4">
              <h2 className="text-lg font-semibold text-teal-400 flex items-center gap-2"><span className="flex items-center justify-center w-6 h-6 rounded-full bg-teal-500/20 text-xs border border-teal-500/30">1</span> Case Details</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-lg font-semibold text-teal-400 flex items-center gap-2"><span className="flex items-center justify-center w-6 h-6 rounded-full bg-teal-500/20 text-xs border border-teal-500/30">2</span> Evidence Upload</h2>
...
/* =========================================
   PART 2: THE LANDING PAGE (Marketing)
   Matches screenshot: "Win Your Disputes Faster"
   ========================================= */
    ...
    <div className="min-h-screen bg-[#020617] text-slate-100 font-sans selection:bg-teal-500/30">
        ...
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="bg-teal-500 hover:bg-teal-400 text-[#020617] px-4 py-2 rounded-lg font-bold text-sm transition-all shadow-lg shadow-teal-500/20"
            >
              Get Started
            </button>
          </div>
      ...
      <div className="container mx-auto px-6 pt-20 pb-20 text-center max-w-5xl">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <button 
            onClick={onGetStarted}
            className="h-12 px-8 rounded-xl bg-teal-500 hover:bg-teal-400 text-[#020617] font-bold text-lg flex items-center gap-2 transition-all shadow-xl shadow-teal-500/20 hover:scale-105"
          >
